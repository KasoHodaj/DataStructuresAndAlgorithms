...
import LinkedListPackage.List;
import LinkedListPackage.ListEmptyException;
import LinkedListPackage.Node;

public class LinkedList implements List {

    LinkedListPackage.Node firstNode;
    private LinkedListPackage.Node lastNode;
    ...
    public int size() {
        ...
        LinkedListPackage.Node current = firstNode;
    ...
    public void insertFirst(Object data) { //ΕΙΣΟΔΟΣ ΣΤΟΙΧΕΙΟΥ ΑΠΟ ΤΗΝ ΑΡΧΗ ΤΗΣ ΛΙΣΤΑΣ
        if (isEmpty()) { // If the list is empty, create a new node and make it both the first and last node.
            firstNode = new LinkedListPackage.Node(data, null);
            lastNode = firstNode;
        } else { // If the list is not empty, create a new node and insert it at the beginning of the list.
            LinkedListPackage.Node newNode = new LinkedListPackage.Node(data, null);
    ...
    public Object removeLast() throws ListEmptyException { //ΑΦΑΙΡΕΣΗ ΣΤΟΙΧΕΙΟΥ ΑΠΟ ΤΟ ΤΕΛΟΣ ΤΗΣ ΛΙΣΤΑΣ
        ...
        if (firstNode == lastNode) { //Check if there is only one node in the list
            ...
            LinkedListPackage.Node curr = firstNode; //Create a temporary variable curr
